...
<div class="scr-page">
  ...
  <ul>
    <li><b>pushRoute: </b>pushes a route forward.</li>
    <li>
      <b>backRoute: </b>back to the first route history, uses
  ...
  <pre
    class="scr-pre"><b class="scr-b">// Importing pushRoute function
    </b>
...
&lt;/script&gt;
  ...
  <pre
    class="scr-pre"><b class="scr-b">// Importing backRoute function
    </b>
