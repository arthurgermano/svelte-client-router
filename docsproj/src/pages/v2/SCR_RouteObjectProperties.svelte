...
&#125;
    ...
    <p class="scr-text-justify">
      ...
      not understand if it is set as suffix.
    </p>
    <pre class="scr-pre"><b class="scr-b"
        >// ## Route Path
...
&#125;
    ...
    <!-- ------------------------------------------------------------------------------ -->
    <!-- ----------------  LOADING PARAMS OPTION  ------------------------------------- -->
    <hr class="scr-hr" />
    <h4 class="scr-h4">Loading Params</h4>
    <p class="scr-text-justify">
      The <b>loadingParams</b> option is an object that will be available on
      loading component.
      <br />
    ...
    <pre class="scr-pre"><b class="scr-b"
        >// ## Loading Params - all props that must be available to
...
&#125;
    ...
    <p class="scr-text-justify">
      ...
      <br />
      <br />
      If this is a feature you want to execute just set to true.
    </p>
    <pre class="scr-pre"><b class="scr-b"
