...
<SCR_Page
  back={{ name: "v1_Getting_Started", text: "Getting Started" }}
  forward={{ name: "v1_Configuration_Global_Before_Enter_Option", text: "Configuration Before Enter" }}
>
<div class="scr-page">
...
import &#123; SCR_CONFIG_STORE &#125; from "svelte-client-router"
  ...
  <pre
    class="scr-pre"><b class="scr-b">// ## Hash Mode checks route using #/ before the location path
...
SCR_CONFIG_STORE.setHashMode(true);
  ...
  <pre
    class="scr-pre"><b class="scr-b">// ## Navigation History Limit is the amount of route history is added 
...
SCR_CONFIG_STORE.setNavigationHistoryLimit(10);
  ...
  <pre
    class="scr-pre"><b class="scr-b">// ## Save mode sets the type of saving history route and store
...
SCR_CONFIG_STORE.setSaveMode("localstorage");
  ...
  <pre
    class="scr-pre"><b class="scr-b">// ## Not Found Route Path
...
SCR_CONFIG_STORE.setNotFoundRoute("/notFound");
  ...
  <pre
    class="scr-pre"><b class="scr-b">// ## Error Route Path
...
SCR_CONFIG_STORE.setErrorRoute("/error");
  ...
  <pre
    class="scr-pre"><b class="scr-b">// ## Console Log Error Messages logs in the console 
...
SCR_CONFIG_STORE.setConsoleLogErrorMessages(true);
  ...
  <pre
    class="scr-pre"><b class="scr-b">// ## Console Log Stores logs in the console 
...
SCR_CONFIG_STORE.setConsoleLogStores(true);
  ...
  <pre
    class="scr-pre"><b class="scr-b">// ## Uses Route Layout defines if you will be using layout 
...
SCR_CONFIG_STORE.setUsesRouteLayout(true);
  ...
  <pre
    class="scr-pre"><b class="scr-b">// ## Consider Trailing Slash On Matching Route
...
SCR_CONFIG_STORE.setConsiderTrailingSlashOnMatchingRoute(true);
  ...
  <pre
    class="scr-pre"><b class="scr-b">// ## Use Scroll - enable or disables scrolling on entering the route
// ## Boolean
// ## Default value: true
</b>
&#123;
...
SCR_CONFIG_STORE.setUseScroll(true);
  ...
  <pre
    class="scr-pre"><b class="scr-b">// ## Scroll Props
