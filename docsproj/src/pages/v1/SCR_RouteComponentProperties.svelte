...
>
  <div class="scr-page">
    ...
    <p class="scr-text-justify">
      ...
      <SCR_RouterLink
        params={{ name: "v1_Route_Component_Components" }}
...
&lt;SCR_ROUTER_COMPONENT 
  ...
  allProps=&#123;... <b class="scr-b"
        >// Passing parameters to be available in and routes and all components</b
      > &#125;
  allLoadingProps=&#123;... <b class="scr-b"
        >// Passing parameters to be available in and routes in loading component</b
      > &#125;
/&gt;
</pre>
    <hr class="scr-hr" />
    ...
    <p class="scr-text-justify">
      ...
      For more information see the <SCR_RouterLink
        params={{ name: "v1_Route_Object_Properties" }}
        elementProps={{ style: "display: inline; cursor: pointer;" }}
      >
        <a href="/" style="pointer-events: none;"
...
&#125;
    ...
    <p class="scr-text-justify">
      The <b>allLoadingProps</b> option can be passed to the router component. It
      must be an object with all the properties that you want to deliver to every
      route when loading the component.
    </p>
    <pre class="scr-pre"><b class="scr-b">// Example</b>
