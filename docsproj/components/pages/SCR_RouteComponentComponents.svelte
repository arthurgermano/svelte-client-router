...
<div class="scr-page">
  <h4 class="scr-h4">Route Component - Components</h4>
  <p class="scr-text-justify">
    As said throught this documentation it is encouraged to provide your own
...
<b class="scr-b">// Importing your components</b>
...
/&gt;
  ...
  <p class="scr-text-justify">Next an example of Svelte Layout Component:</p>
  <pre
    class="scr-pre">
<b class="scr-b">// Example of a Svelte Layout Component</b>
&lt;script&gt;
...
/&gt;
  ...
  <pre
    class="scr-pre">
<b class="scr-b">// Example of a Svelte Loading Component</b>
&lt;script&gt;
...
/&gt;
  ...
  <p class="scr-text-justify">Next an example of Svelte Not Found Component:</p>
  <pre
    class="scr-pre">
<b class="scr-b">// Example of a Svelte Not Found Component</b>
&lt;script&gt;
...
/&gt;
  ...
  <p class="scr-text-justify">Next an example of Svelte Error Component:</p>
  <pre
    class="scr-pre">
<b class="scr-b">// Example of a Svelte Error Component</b>
&lt;script&gt;
