<script>
  ...
  import SCR_OnErrorAnatomy from "../components/SCR_OnErrorAnatomy.svelte";
</script>

<div class="scr-page">
  <h4 class="scr-h4">Route Object - On Error Function</h4>
...
<b class="scr-b">// Setting Route On Error Function</b>
&#125;
