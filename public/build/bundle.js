...
var app = (function () {
    ...
    */
    ...
    const file$w = "src/components/SCR_NotFound.svelte";
    ...
    function create_fragment$y(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$w, 5, 2, 82);
    			attr_dev(p1, "class", "scr-p-small svelte-zj7cmj");
    			add_location(p1, file$w, 6, 2, 115);
    			add_location(center, file$w, 4, 0, 71);
    		},
    ...
    const file$v = "src/components/SCR_Loading.svelte";
    ...
    class SCR_Loading$2 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$x, create_fragment$x, safe_not_equal, { loadingText: 0 });
    ...
    const file$u = "src/components/SCR_Error.svelte";
    ...
    function create_fragment$w(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$u, 5, 2, 84);
    			attr_dev(p1, "class", "scr-p-small svelte-jhjhwz");
    			add_location(p1, file$u, 6, 2, 113);
    			add_location(center, file$u, 4, 0, 73);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class SCR_Error$1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$w, create_fragment$w, safe_not_equal, { errorMessage: 0 });
    ...
    const file$t = "src/components/SCR_Layout.svelte";
    ...
    // (562:2) {#if $configStore.usesRouteLayout && typeof layoutComponent === "function"}
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, currentComponent, props*/ 1073741834) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(562:2) {#if $configStore.usesRouteLayout && typeof layoutComponent === \\\"function\\\"}",
    		ctx
    	});
    ...
    // (563:4) <svelte:component this={layoutComponent} {...props}>
    function create_default_slot$k(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(563:4) <svelte:component this={layoutComponent} {...props}>",
    		ctx
    	});
    ...
    // (559:23)    <svelte:component this={SCR_LoadingComponent}
    function create_pending_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const switch_instance_changes = (dirty & /*loadingProps, props*/ 6)
    			? get_spread_update(switch_instance_spread_levels, [
    					dirty & /*loadingProps*/ 4 && get_spread_object(/*loadingProps*/ ctx[2]),
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(559:23)    <svelte:component this={SCR_LoadingComponent}",
    		ctx
    	});
    ...
    function create_fragment$u(ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*loadingPromise*/ 16 && promise !== (promise = /*loadingPromise*/ ctx[4]) && handle_promise(promise, info)) ; else {
    ...
    function instance$u($$self, $$props, $$invalidate) {
    	...
    	async function loadRoute(routeObj, isLoading = true) {
    		try {
    			...
    			if (!routeObj) {
    				...
    				await routerStore.setCurrentLocation(routeObj.path); // when navigate tries to find a route passed wrongly or not existent!
    				return pushRoute($configStore.notFoundRoute);
    			}
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$configStore, $routerStore*/ 16385) {
    			// -----------------------------------------------------------------------------------
    		...
    		if ($$self.$$.dirty & /*$configStore, $navigateStore*/ 32769) {
    		...
    		if ($$self.$$.dirty & /*$navigateStore*/ 32768) {
    			// -----------------------------------------------------------------------------------
    ...
    const file$s = "src/components/SCR_RouterLink.svelte";
    ...
    function create_fragment$t(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$s, 17, 0, 393);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$r = "src/docs/SCR_Menu.svelte";
    ...
    function create_default_slot_18(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$r, 7, 4, 187);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_17(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 10, 4, 307);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_16(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 13, 4, 429);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_15(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 17, 4, 605);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_14(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 20, 4, 758);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_13(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 23, 4, 899);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_12(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 27, 4, 1072);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_11(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 30, 4, 1200);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_10(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 33, 4, 1335);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 36, 4, 1467);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div.textContent = "Properties";
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 40, 4, 1642);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 43, 4, 1772);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 47, 4, 1937);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 50, 4, 2055);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div.textContent = "Properties";
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 54, 4, 2218);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div.textContent = "Properties";
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 58, 4, 2389);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 62, 4, 2547);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_1$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 65, 4, 2674);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot$j(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scr-btn");
    			add_location(div, file$r, 68, 4, 2824);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    const file$q = "src/docs/SCR_Layout.svelte";
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$q, 8, 6, 199);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$r(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$q, 6, 2, 139);
    			attr_dev(div1, "class", "scr-pages svelte-lxpf7t");
    			add_location(div1, file$q, 15, 4, 369);
    			attr_dev(div2, "class", "scr-main svelte-lxpf7t");
    			add_location(div2, file$q, 13, 2, 325);
    			add_location(b0, file$q, 25, 6, 625);
    			add_location(br0, file$q, 26, 6, 662);
    			add_location(br1, file$q, 27, 6, 675);
    			add_location(b1, file$q, 28, 6, 688);
    			attr_dev(a0, "href", "https://en.wikipedia.org/wiki/MIT_License");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$q, 29, 6, 710);
    			attr_dev(div3, "class", "scr-footer-left");
    			add_location(div3, file$q, 24, 4, 589);
    			add_location(b2, file$q, 33, 6, 845);
    			attr_dev(a1, "href", "https://github.com/arthurgermano/svelte-client-router");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$q, 33, 21, 860);
    			add_location(br2, file$q, 37, 6, 1027);
    			add_location(br3, file$q, 38, 6, 1040);
    			add_location(b3, file$q, 39, 6, 1053);
    			attr_dev(a2, "href", "https://www.npmjs.com/package/svelte-client-router");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file$q, 39, 18, 1065);
    			attr_dev(div4, "class", "scr-footer-right");
    			add_location(div4, file$q, 32, 4, 808);
    			attr_dev(div5, "class", "scr-footer svelte-lxpf7t");
    			add_location(div5, file$q, 23, 2, 560);
    			attr_dev(div6, "class", "scr-main-layout svelte-lxpf7t");
    			add_location(div6, file$q, 5, 0, 107);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$p = "src/docs/SCR_NotFound.svelte";
    ...
    function create_fragment$q(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$p, 6, 2, 137);
    			attr_dev(p1, "class", "scr-p-small svelte-f7tw5n");
    			add_location(p1, file$p, 7, 2, 170);
    			add_location(br, file$p, 8, 2, 239);
    			attr_dev(div0, "class", "scr-btn svelte-f7tw5n");
    			add_location(div0, file$p, 10, 4, 258);
    			add_location(div1, file$p, 9, 2, 248);
    			add_location(center, file$p, 5, 0, 126);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$o = "src/docs/SCR_Error.svelte";
    ...
    function create_fragment$p(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$o, 7, 2, 140);
    			attr_dev(p1, "class", "scr-p-small svelte-dz0sst");
    			add_location(p1, file$o, 8, 2, 169);
    			add_location(br0, file$o, 9, 2, 213);
    			add_location(br1, file$o, 10, 2, 222);
    			attr_dev(div0, "class", "scr-btn svelte-dz0sst");
    			add_location(div0, file$o, 12, 4, 241);
    			add_location(div1, file$o, 11, 2, 231);
    			add_location(center, file$o, 6, 0, 129);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class SCR_Error extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$p, create_fragment$p, safe_not_equal, { errorMessage: 0 });
    ...
    const file$n = "src/docs/SCR_PageFooter.svelte";
    ...
    const file$m = "src/docs/components/SCR_PushRouteButton.svelte";
    ...
    function create_fragment$n(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$m, 12, 0, 238);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/docs/pages/SCR_TestLoadingComponentWithBeforeEnter.svelte generated by Svelte v3.37.0 */
    const file$l = "src/docs/pages/SCR_TestLoadingComponentWithBeforeEnter.svelte";

    // (102:2) <SCR_ROUTER_LINK     to={{       path: `/svelte-client-router/testLoadingComponentWithBeforeEnter/${timeoutParam || 10}?subLoadingText=${queryParam}`,     }}   >
    function create_default_slot_1$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$l, 106, 4, 3017);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(102:2) <SCR_ROUTER_LINK     to={{       path: `/svelte-client-router/testLoadingComponentWithBeforeEnter/${timeoutParam || 10}?subLoadingText=${queryParam}`,     }}   >",
    		ctx
    	});
    ...
    function create_default_slot$i(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$l, 135, 6, 3997);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$l, 134, 4, 3973);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$m(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			ul1 = element("ul");
    			li6 = element("li");
    			li6.textContent = "Try it via browser URL - passing at end of this route ?subLoadingText=MyCustomText!";
    			t17 = space();
    			li7 = element("li");
    			li7.textContent = "Before Enter Route";
    			t19 = space();
    			p1 = element("p");
    			t20 = text("The default value is 2000 milliseconds. If nothing is declared it is assumed 2000.\n    Or if it is passed a valid number greater than 10 milliseconds it will wait the milliseconds specified.\n    ");
    			br0 = element("br");
    			t21 = space();
    			br1 = element("br");
    			t22 = space();
    			b0 = element("b");
    			b0.textContent = "Important: All the variables captured by this component are passed to all components!";
    			t24 = space();
    			p2 = element("p");
    			...
    			add_location(h4, file$l, 44, 2, 1043);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$l, 45, 2, 1118);
    			add_location(li0, file$l, 49, 4, 1235);
    			add_location(li1, file$l, 50, 4, 1270);
    			add_location(li2, file$l, 51, 4, 1347);
    			add_location(li3, file$l, 53, 6, 1409);
    			add_location(li4, file$l, 54, 6, 1436);
    			add_location(ul0, file$l, 52, 4, 1398);
    			add_location(li5, file$l, 56, 4, 1472);
    			add_location(li6, file$l, 58, 8, 1521);
    			add_location(ul1, file$l, 57, 6, 1508);
    			add_location(li7, file$l, 60, 4, 1630);
    			add_location(ul2, file$l, 48, 2, 1226);
    			add_location(br0, file$l, 65, 4, 1896);
    			add_location(br1, file$l, 66, 4, 1907);
    			add_location(b0, file$l, 67, 4, 1918);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$l, 62, 2, 1668);
    			add_location(b1, file$l, 70, 44, 2093);
    			add_location(br2, file$l, 71, 4, 2131);
    			add_location(b2, file$l, 72, 37, 2175);
    			add_location(br3, file$l, 73, 4, 2221);
    			add_location(br4, file$l, 74, 4, 2232);
    			attr_dev(p2, "class", "scr-text-justify");
    			add_location(p2, file$l, 69, 2, 2020);
    			attr_dev(label0, "for", "scr-timeout-param");
    			attr_dev(label0, "class", "form-label");
    			add_location(label0, file$l, 78, 4, 2283);
    			...
    			add_location(input0, file$l, 81, 4, 2382);
    			attr_dev(div0, "class", "mb-3");
    			add_location(div0, file$l, 77, 2, 2260);
    			attr_dev(label1, "for", "scr-query-param");
    			attr_dev(label1, "class", "form-label");
    			add_location(label1, file$l, 90, 4, 2586);
    			...
    			add_location(input1, file$l, 93, 4, 2676);
    			attr_dev(div1, "class", "mb-3");
    			add_location(div1, file$l, 89, 2, 2563);
    			attr_dev(hr, "class", "scr-hr");
    			add_location(hr, file$l, 108, 2, 3089);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$l, 110, 4, 3145);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$l, 109, 2, 3113);
    			attr_dev(b3, "class", "scr-b");
    			add_location(b3, file$l, 118, 2, 3392);
    			attr_dev(b4, "class", "scr-b");
    			add_location(b4, file$l, 124, 2, 3610);
    			attr_dev(pre, "class", "scr-pre");
    			add_location(pre, file$l, 112, 2, 3226);
    			attr_dev(div2, "class", "scr-page");
    			add_location(div2, file$l, 43, 0, 1018);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class SCR_TestLoadingComponentWithBeforeEnter extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$m, create_fragment$m, safe_not_equal, { pathParams: 0, queryParams: 1 });
    ...
    const file$k = "src/docs/pages/SCR_Presentation.svelte";
    ...
    function create_default_slot$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$k, 72, 6, 2604);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$k, 71, 4, 2580);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$k(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pagefooter.$$.fragment);
    			attr_dev(h4, "class", "scr-h4");
    			add_location(h4, file$k, 6, 2, 180);
    			add_location(br0, file$k, 10, 4, 370);
    			add_location(br1, file$k, 11, 4, 381);
    			add_location(br2, file$k, 15, 4, 575);
    			add_location(br3, file$k, 16, 4, 586);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$k, 7, 2, 219);
    			attr_dev(li0, "class", "scr-li svelte-1kf261k");
    			add_location(li0, file$k, 20, 4, 644);
    			attr_dev(li1, "class", "scr-li svelte-1kf261k");
    			add_location(li1, file$k, 21, 4, 705);
    			add_location(u0, file$k, 23, 40, 821);
    			add_location(b0, file$k, 23, 37, 818);
    			attr_dev(li2, "class", "scr-li svelte-1kf261k");
    			add_location(li2, file$k, 22, 4, 761);
    			add_location(u1, file$k, 26, 40, 916);
    			add_location(b1, file$k, 26, 37, 913);
    			attr_dev(li3, "class", "scr-li svelte-1kf261k");
    			add_location(li3, file$k, 25, 4, 856);
    			attr_dev(li4, "class", "scr-li svelte-1kf261k");
    			add_location(li4, file$k, 28, 4, 952);
    			attr_dev(li5, "class", "scr-li svelte-1kf261k");
    			add_location(li5, file$k, 31, 4, 1056);
    			attr_dev(li6, "class", "scr-li svelte-1kf261k");
    			add_location(li6, file$k, 32, 4, 1130);
    			attr_dev(li7, "class", "scr-li svelte-1kf261k");
    			add_location(li7, file$k, 33, 4, 1210);
    			attr_dev(li8, "class", "scr-li svelte-1kf261k");
    			add_location(li8, file$k, 37, 4, 1334);
    			attr_dev(li9, "class", "scr-li svelte-1kf261k");
    			add_location(li9, file$k, 38, 4, 1411);
    			attr_dev(li10, "class", "scr-li svelte-1kf261k");
    			add_location(li10, file$k, 39, 4, 1470);
    			attr_dev(li11, "class", "scr-li svelte-1kf261k");
    			add_location(li11, file$k, 43, 4, 1602);
    			add_location(ul, file$k, 19, 2, 635);
    			add_location(br4, file$k, 50, 4, 1955);
    			add_location(br5, file$k, 51, 4, 1966);
    			add_location(br6, file$k, 55, 4, 2171);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$k, 45, 2, 1672);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$k, 59, 4, 2248);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$k, 58, 2, 2216);
    			attr_dev(pre, "class", "scr-pre");
    			add_location(pre, file$k, 61, 2, 2329);
    			attr_dev(div, "class", "scr-page");
    			add_location(div, file$k, 5, 0, 155);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$j = "src/docs/pages/SCR_Installation.svelte";
    ...
    function create_default_slot$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$j, 46, 6, 1246);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$j, 45, 4, 1222);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$j(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pagefooter.$$.fragment);
    			attr_dev(h4, "class", "scr-h4");
    			add_location(h4, file$j, 6, 2, 180);
    			add_location(h50, file$j, 7, 2, 219);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$j, 8, 2, 239);
    			add_location(h51, file$j, 11, 2, 309);
    			attr_dev(b0, "class", "scr-b");
    			add_location(b0, file$j, 14, 4, 374);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$j, 12, 2, 344);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$j, 28, 4, 718);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$j, 27, 2, 686);
    			attr_dev(b1, "class", "scr-b");
    			add_location(b1, file$j, 32, 4, 829);
    			attr_dev(pre2, "class", "scr-pre");
    			add_location(pre2, file$j, 30, 2, 799);
    			attr_dev(div, "class", "scr-page");
    ...
    const file$i = "src/docs/pages/SCR_GettingStarted.svelte";
    ...
    function create_default_slot$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$i, 148, 6, 4596);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$i, 147, 4, 4572);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$i(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h50, file$i, 7, 2, 222);
    			attr_dev(b0, "class", "scr-b");
    			add_location(b0, file$i, 20, 0, 493);
    			attr_dev(a0, "href", "https://svelte.dev/tutorial/slots");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$i, 21, 20, 624);
    			attr_dev(b1, "class", "scr-b");
    			add_location(b1, file$i, 21, 0, 604);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$i, 8, 2, 266);
    			add_location(br0, file$i, 24, 2, 791);
    			add_location(h51, file$i, 25, 2, 800);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$i, 26, 2, 828);
    			add_location(br1, file$i, 59, 2, 1796);
    			add_location(h52, file$i, 60, 2, 1805);
    			attr_dev(pre2, "class", "scr-pre");
    			add_location(pre2, file$i, 61, 2, 1836);
    			add_location(br2, file$i, 67, 4, 2053);
    			add_location(br3, file$i, 68, 4, 2064);
    			attr_dev(p, "class", "scr-text-justify");
    			add_location(p, file$i, 65, 2, 1965);
    			add_location(br4, file$i, 72, 2, 2209);
    			add_location(h53, file$i, 73, 2, 2218);
    			attr_dev(b2, "class", "scr-b");
    			add_location(b2, file$i, 76, 0, 2268);
    			attr_dev(b3, "class", "scr-b");
    			add_location(b3, file$i, 79, 0, 2325);
    			attr_dev(b4, "class", "scr-b");
    			add_location(b4, file$i, 90, 0, 2577);
    			attr_dev(a1, "href", "https://svelte.dev/tutorial/slots");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$i, 91, 20, 2708);
    			attr_dev(b5, "class", "scr-b");
    			add_location(b5, file$i, 91, 0, 2688);
    			attr_dev(b6, "class", "scr-b");
    			add_location(b6, file$i, 92, 0, 2809);
    			attr_dev(b7, "class", "scr-b");
    			add_location(b7, file$i, 95, 0, 2919);
    			attr_dev(b8, "class", "scr-b");
    			add_location(b8, file$i, 98, 6, 2992);
    			attr_dev(b9, "class", "scr-b");
    			add_location(b9, file$i, 130, 0, 3987);
    			attr_dev(pre3, "class", "scr-pre");
    			add_location(pre3, file$i, 74, 2, 2242);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$i, 134, 4, 4219);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$i, 133, 2, 4187);
    			attr_dev(pre4, "class", "scr-pre");
    			add_location(pre4, file$i, 136, 2, 4300);
    			attr_dev(div, "class", "scr-page");
    ...
    const file$h = "src/docs/pages/SCR_ConfigurationOptions.svelte";
    ...
    function create_default_slot$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$h, 376, 6, 12556);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$h, 375, 4, 12532);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h40, file$h, 6, 2, 180);
    			attr_dev(a, "href", "https://svelte.dev/tutorial/writable-stores");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$h, 8, 39, 271);
    			add_location(p0, file$h, 7, 2, 228);
    			add_location(h5, file$h, 16, 2, 593);
    			attr_dev(b0, "class", "scr-b");
    			add_location(b0, file$h, 19, 0, 640);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$h, 17, 2, 614);
    			add_location(p1, file$h, 22, 2, 771);
    			attr_dev(hr0, "class", "scr-hr");
    			add_location(hr0, file$h, 24, 2, 922);
    			attr_dev(h41, "class", "scr-h4");
    			add_location(h41, file$h, 25, 2, 946);
    			add_location(b1, file$h, 27, 8, 1019);
    			add_location(b2, file$h, 28, 39, 1131);
    			add_location(br0, file$h, 30, 4, 1224);
    			add_location(br1, file$h, 31, 4, 1235);
    			attr_dev(p2, "class", "scr-text-justify");
    			add_location(p2, file$h, 26, 2, 982);
    			attr_dev(b3, "class", "scr-b");
    			add_location(b3, file$h, 37, 0, 1422);
    			attr_dev(b4, "class", "scr-b");
    			add_location(b4, file$h, 48, 0, 1705);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$h, 35, 2, 1396);
    			attr_dev(hr1, "class", "scr-hr");
    			add_location(hr1, file$h, 53, 2, 1982);
    			attr_dev(h42, "class", "scr-h4");
    			add_location(h42, file$h, 54, 2, 2006);
    			add_location(b5, file$h, 56, 8, 2094);
    			add_location(br2, file$h, 60, 4, 2364);
    			add_location(br3, file$h, 61, 4, 2375);
    			attr_dev(p3, "class", "scr-text-justify");
    			add_location(p3, file$h, 55, 2, 2057);
    			attr_dev(b6, "class", "scr-b");
    			add_location(b6, file$h, 66, 0, 2474);
    			attr_dev(b7, "class", "scr-b");
    			add_location(b7, file$h, 77, 0, 2732);
    			attr_dev(pre2, "class", "scr-pre");
    			add_location(pre2, file$h, 64, 2, 2448);
    			attr_dev(hr2, "class", "scr-hr");
    			add_location(hr2, file$h, 82, 2, 3021);
    			attr_dev(h43, "class", "scr-h4");
    			add_location(h43, file$h, 83, 2, 3045);
    			add_location(b8, file$h, 85, 8, 3118);
    			attr_dev(p4, "class", "scr-text-justify");
    			add_location(p4, file$h, 84, 2, 3081);
    			add_location(b9, file$h, 89, 6, 3197);
    			add_location(li0, file$h, 88, 4, 3186);
    			add_location(b10, file$h, 91, 8, 3290);
    			add_location(li1, file$h, 91, 4, 3286);
    			add_location(b11, file$h, 92, 8, 3369);
    			add_location(li2, file$h, 92, 4, 3365);
    			add_location(ul0, file$h, 87, 2, 3177);
    			add_location(p5, file$h, 94, 2, 3430);
    			attr_dev(b12, "class", "scr-b");
    			add_location(b12, file$h, 101, 0, 3634);
    			attr_dev(b13, "class", "scr-b");
    			add_location(b13, file$h, 114, 0, 4058);
    			attr_dev(pre3, "class", "scr-pre");
    			add_location(pre3, file$h, 99, 2, 3608);
    			attr_dev(hr3, "class", "scr-hr");
    			add_location(hr3, file$h, 119, 2, 4345);
    			attr_dev(h44, "class", "scr-h4");
    			add_location(h44, file$h, 120, 2, 4369);
    			add_location(b14, file$h, 122, 8, 4448);
    			add_location(br4, file$h, 124, 4, 4559);
    			add_location(br5, file$h, 125, 4, 4570);
    			add_location(b15, file$h, 126, 4, 4581);
    			attr_dev(p6, "class", "scr-text-justify");
    			add_location(p6, file$h, 121, 2, 4411);
    			attr_dev(b16, "class", "scr-b");
    			add_location(b16, file$h, 130, 0, 4654);
    			attr_dev(b17, "class", "scr-b");
    			add_location(b17, file$h, 140, 0, 4888);
    			attr_dev(pre4, "class", "scr-pre");
    			add_location(pre4, file$h, 128, 2, 4628);
    			attr_dev(hr4, "class", "scr-hr");
    			add_location(hr4, file$h, 145, 2, 5177);
    			attr_dev(h45, "class", "scr-h4");
    			add_location(h45, file$h, 146, 2, 5201);
    			add_location(b18, file$h, 148, 8, 5276);
    			add_location(br6, file$h, 150, 4, 5361);
    			add_location(br7, file$h, 151, 4, 5372);
    			add_location(b19, file$h, 152, 4, 5383);
    			attr_dev(p7, "class", "scr-text-justify");
    			add_location(p7, file$h, 147, 2, 5239);
    			attr_dev(b20, "class", "scr-b");
    			add_location(b20, file$h, 156, 0, 5456);
    			attr_dev(b21, "class", "scr-b");
    			add_location(b21, file$h, 166, 0, 5679);
    			attr_dev(pre5, "class", "scr-pre");
    			add_location(pre5, file$h, 154, 2, 5430);
    			attr_dev(hr5, "class", "scr-hr");
    			add_location(hr5, file$h, 171, 2, 5962);
    			attr_dev(h46, "class", "scr-h4");
    			add_location(h46, file$h, 172, 2, 5986);
    			add_location(b22, file$h, 174, 8, 6076);
    			add_location(br8, file$h, 176, 4, 6181);
    			add_location(br9, file$h, 177, 4, 6192);
    			attr_dev(p8, "class", "scr-text-justify");
    			add_location(p8, file$h, 173, 2, 6039);
    			attr_dev(b23, "class", "scr-b");
    			add_location(b23, file$h, 182, 0, 6320);
    			attr_dev(b24, "class", "scr-b");
    			add_location(b24, file$h, 192, 0, 6538);
    			attr_dev(pre6, "class", "scr-pre");
    			add_location(pre6, file$h, 180, 2, 6294);
    			attr_dev(hr6, "class", "scr-hr");
    			add_location(hr6, file$h, 197, 2, 6828);
    			attr_dev(h47, "class", "scr-h4");
    			add_location(h47, file$h, 198, 2, 6852);
    			add_location(b25, file$h, 200, 8, 6934);
    			add_location(br10, file$h, 202, 4, 7019);
    			add_location(br11, file$h, 203, 4, 7030);
    			attr_dev(p9, "class", "scr-text-justify");
    			add_location(p9, file$h, 199, 2, 6897);
    			attr_dev(b26, "class", "scr-b");
    			add_location(b26, file$h, 208, 0, 7114);
    			attr_dev(b27, "class", "scr-b");
    			add_location(b27, file$h, 218, 0, 7329);
    			attr_dev(pre7, "class", "scr-pre");
    			add_location(pre7, file$h, 206, 2, 7088);
    			attr_dev(hr7, "class", "scr-hr");
    			add_location(hr7, file$h, 223, 2, 7614);
    			attr_dev(h48, "class", "scr-h4");
    			add_location(h48, file$h, 224, 2, 7638);
    			add_location(b28, file$h, 226, 8, 7719);
    			add_location(br12, file$h, 228, 4, 7814);
    			add_location(br13, file$h, 229, 4, 7825);
    			add_location(br14, file$h, 232, 4, 7977);
    			add_location(br15, file$h, 233, 4, 7988);
    			attr_dev(p10, "class", "scr-text-justify");
    			add_location(p10, file$h, 225, 2, 7682);
    			attr_dev(b29, "class", "scr-b");
    			add_location(b29, file$h, 239, 0, 8197);
    			attr_dev(b30, "class", "scr-b");
    			add_location(b30, file$h, 249, 0, 8421);
    			attr_dev(pre8, "class", "scr-pre");
    			add_location(pre8, file$h, 237, 2, 8171);
    			attr_dev(hr8, "class", "scr-hr");
    			add_location(hr8, file$h, 254, 2, 8705);
    			attr_dev(h49, "class", "scr-h4");
    			add_location(h49, file$h, 255, 2, 8729);
    			add_location(b31, file$h, 257, 8, 8834);
    			attr_dev(p11, "class", "scr-text-justify");
    			add_location(p11, file$h, 256, 2, 8797);
    			attr_dev(b32, "class", "scr-b");
    			add_location(b32, file$h, 262, 0, 9025);
    			attr_dev(b33, "class", "scr-b");
    			add_location(b33, file$h, 272, 0, 9279);
    			attr_dev(pre9, "class", "scr-pre");
    			add_location(pre9, file$h, 260, 2, 8999);
    			attr_dev(hr9, "class", "scr-hr");
    			add_location(hr9, file$h, 277, 2, 9584);
    			attr_dev(h410, "class", "scr-h4");
    			add_location(h410, file$h, 278, 2, 9608);
    			add_location(b34, file$h, 280, 8, 9682);
    			add_location(b35, file$h, 281, 61, 9808);
    			add_location(b36, file$h, 283, 4, 9913);
    			add_location(b37, file$h, 284, 25, 9957);
    			attr_dev(p12, "class", "scr-text-justify");
    			add_location(p12, file$h, 279, 2, 9645);
    			attr_dev(b38, "class", "scr-b");
    			add_location(b38, file$h, 288, 0, 10022);
    			attr_dev(b39, "class", "scr-b");
    			add_location(b39, file$h, 297, 0, 10188);
    			attr_dev(pre10, "class", "scr-pre");
    			add_location(pre10, file$h, 286, 2, 9996);
    			attr_dev(hr10, "class", "scr-hr");
    			add_location(hr10, file$h, 302, 2, 10466);
    			attr_dev(h411, "class", "scr-h4");
    			add_location(h411, file$h, 303, 2, 10490);
    			add_location(b40, file$h, 305, 8, 10566);
    			attr_dev(p13, "class", "scr-text-justify");
    			add_location(p13, file$h, 304, 2, 10529);
    			add_location(b41, file$h, 309, 8, 10704);
    			add_location(li3, file$h, 309, 4, 10700);
    			add_location(b42, file$h, 310, 8, 10771);
    			add_location(li4, file$h, 310, 4, 10767);
    			add_location(b43, file$h, 312, 6, 10847);
    			add_location(li5, file$h, 311, 4, 10836);
    			add_location(b44, file$h, 316, 6, 10959);
    			add_location(li6, file$h, 315, 4, 10948);
    			add_location(ul1, file$h, 308, 2, 10691);
    			attr_dev(b45, "class", "scr-b");
    			add_location(b45, file$h, 322, 0, 11153);
    			attr_dev(b46, "class", "scr-b");
    			add_location(b46, file$h, 348, 0, 11750);
    			attr_dev(pre11, "class", "scr-pre");
    			add_location(pre11, file$h, 320, 2, 11127);
    			attr_dev(p14, "class", "scr-text-justify");
    			add_location(p14, file$h, 356, 2, 11913);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$h, 363, 4, 12156);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$h, 362, 2, 12124);
    			attr_dev(pre12, "class", "scr-pre");
    			add_location(pre12, file$h, 365, 2, 12237);
    			attr_dev(div, "class", "scr-page");
    ...
    const file$g = "src/docs/components/SCR_BeforeEnterRouteAnatomy.svelte";
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h4, "class", "scr-h4");
    			add_location(h4, file$g, 0, 0, 0);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$g, 1, 0, 61);
    			attr_dev(b0, "class", "scr-b");
    			add_location(b0, file$g, 7, 0, 266);
    			attr_dev(pre, "class", "scr-pre");
    			add_location(pre, file$g, 5, 0, 242);
    			add_location(b1, file$g, 14, 4, 458);
    			add_location(br0, file$g, 17, 4, 657);
    			add_location(b2, file$g, 22, 8, 810);
    			add_location(li0, file$g, 21, 6, 797);
    			add_location(b3, file$g, 26, 8, 943);
    			add_location(li1, file$g, 25, 6, 930);
    			add_location(b4, file$g, 30, 8, 1091);
    			add_location(br1, file$g, 33, 8, 1308);
    			add_location(br2, file$g, 35, 8, 1388);
    			add_location(br3, file$g, 36, 8, 1403);
    			add_location(li2, file$g, 29, 6, 1078);
    			add_location(b5, file$g, 39, 8, 1441);
    			add_location(br4, file$g, 42, 8, 1654);
    			add_location(br5, file$g, 44, 8, 1730);
    			add_location(br6, file$g, 45, 8, 1745);
    			add_location(li3, file$g, 38, 6, 1428);
    			add_location(b6, file$g, 48, 8, 1783);
    			add_location(br7, file$g, 51, 8, 2010);
    			add_location(br8, file$g, 53, 8, 2090);
    			add_location(br9, file$g, 54, 8, 2105);
    			add_location(li4, file$g, 47, 6, 1770);
    			add_location(ul0, file$g, 20, 4, 786);
    			add_location(li5, file$g, 13, 2, 449);
    			add_location(b7, file$g, 59, 4, 2153);
    			add_location(b8, file$g, 62, 10, 2307);
    			add_location(li6, file$g, 62, 6, 2303);
    			add_location(b9, file$g, 63, 10, 2357);
    			add_location(li7, file$g, 63, 6, 2353);
    			add_location(b10, file$g, 65, 8, 2422);
    			add_location(li8, file$g, 64, 6, 2409);
    			add_location(b11, file$g, 68, 8, 2522);
    			add_location(li9, file$g, 67, 6, 2509);
    			add_location(b12, file$g, 72, 8, 2638);
    			add_location(li10, file$g, 71, 6, 2625);
    			add_location(b13, file$g, 76, 8, 2777);
    			add_location(li11, file$g, 75, 6, 2764);
    			add_location(b14, file$g, 79, 10, 2909);
    			add_location(li12, file$g, 79, 6, 2905);
    			add_location(b15, file$g, 80, 10, 2979);
    			add_location(li13, file$g, 80, 6, 2975);
    			add_location(ul1, file$g, 61, 4, 2292);
    			add_location(li14, file$g, 58, 2, 2144);
    			add_location(br10, file$g, 83, 2, 3061);
    			add_location(b16, file$g, 85, 4, 3079);
    			add_location(b17, file$g, 88, 10, 3228);
    			add_location(li15, file$g, 88, 6, 3224);
    			add_location(b18, file$g, 89, 10, 3278);
    			add_location(li16, file$g, 89, 6, 3274);
    			add_location(b19, file$g, 91, 8, 3343);
    			add_location(li17, file$g, 90, 6, 3330);
    			add_location(b20, file$g, 94, 8, 3443);
    			add_location(li18, file$g, 93, 6, 3430);
    			add_location(b21, file$g, 98, 8, 3559);
    			add_location(li19, file$g, 97, 6, 3546);
    			add_location(b22, file$g, 102, 8, 3698);
    			add_location(li20, file$g, 101, 6, 3685);
    			add_location(b23, file$g, 105, 10, 3830);
    			add_location(li21, file$g, 105, 6, 3826);
    			add_location(b24, file$g, 106, 10, 3900);
    			add_location(li22, file$g, 106, 6, 3896);
    			add_location(ul2, file$g, 87, 4, 3213);
    			add_location(li23, file$g, 84, 2, 3070);
    			add_location(br11, file$g, 109, 2, 3982);
    			add_location(b25, file$g, 111, 4, 4000);
    			add_location(li24, file$g, 110, 2, 3991);
    			add_location(br12, file$g, 115, 2, 4238);
    			add_location(b26, file$g, 117, 4, 4256);
    			add_location(br13, file$g, 120, 4, 4482);
    			add_location(b27, file$g, 122, 6, 4524);
    			set_style(span, "color", "red");
    			add_location(span, file$g, 121, 4, 4493);
    			add_location(li25, file$g, 116, 2, 4247);
    			add_location(ul3, file$g, 12, 0, 442);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$g, 128, 0, 4746);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$f = "src/docs/pages/SCR_ConfigurationBeforeEnter.svelte";
    ...
    function create_default_slot_1$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$f, 32, 6, 1468);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$f, 74, 6, 2958);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$f, 73, 4, 2934);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pagefooter.$$.fragment);
    			attr_dev(h4, "class", "scr-h4");
    			add_location(h4, file$f, 8, 2, 326);
    			add_location(b0, file$f, 10, 8, 427);
    			add_location(b1, file$f, 12, 4, 565);
    			add_location(br0, file$f, 14, 4, 649);
    			add_location(br1, file$f, 15, 4, 660);
    			add_location(br2, file$f, 20, 4, 963);
    			add_location(br3, file$f, 21, 4, 974);
    			add_location(b2, file$f, 23, 4, 1057);
    			add_location(br4, file$f, 26, 4, 1294);
    			add_location(br5, file$f, 27, 4, 1305);
    			add_location(br6, file$f, 34, 4, 1580);
    			add_location(br7, file$f, 35, 4, 1591);
    			attr_dev(p, "class", "scr-text-justify");
    			add_location(p, file$f, 9, 2, 390);
    			attr_dev(b3, "class", "scr-b");
    			add_location(b3, file$f, 40, 0, 1685);
    			attr_dev(b4, "class", "scr-b");
    			add_location(b4, file$f, 43, 0, 1820);
    			attr_dev(b5, "class", "scr-b");
    			add_location(b5, file$f, 44, 0, 1878);
    			attr_dev(b6, "class", "scr-b");
    			add_location(b6, file$f, 47, 0, 2019);
    			attr_dev(b7, "class", "scr-b");
    			add_location(b7, file$f, 49, 0, 2048);
    			attr_dev(b8, "class", "scr-b");
    			add_location(b8, file$f, 50, 0, 2117);
    			attr_dev(b9, "class", "scr-b");
    			add_location(b9, file$f, 51, 0, 2179);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$f, 38, 2, 1659);
    			add_location(br8, file$f, 58, 2, 2452);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$f, 61, 4, 2527);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$f, 60, 2, 2495);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$f, 63, 2, 2608);
    			attr_dev(div, "class", "scr-page");
    			add_location(div, file$f, 7, 0, 301);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$e = "src/docs/components/SCR_OnErrorAnatomy.svelte";
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$e, 4, 2, 195);
    			attr_dev(p, "class", "scr-text-justify");
    			add_location(p, file$e, 1, 0, 57);
    			attr_dev(b0, "class", "scr-b");
    			add_location(b0, file$e, 9, 0, 274);
    			attr_dev(pre, "class", "scr-pre");
    			add_location(pre, file$e, 7, 0, 250);
    			add_location(b1, file$e, 16, 4, 429);
    			add_location(li0, file$e, 15, 2, 420);
    			add_location(b2, file$e, 19, 4, 511);
    			add_location(br1, file$e, 21, 4, 599);
    			add_location(b3, file$e, 25, 8, 701);
    			add_location(b4, file$e, 29, 14, 906);
    			add_location(li1, file$e, 29, 10, 902);
    			add_location(b5, file$e, 30, 14, 960);
    			add_location(li2, file$e, 30, 10, 956);
    			add_location(b6, file$e, 32, 12, 1033);
    			add_location(li3, file$e, 31, 10, 1016);
    			add_location(b7, file$e, 35, 12, 1145);
    			add_location(li4, file$e, 34, 10, 1128);
    			add_location(b8, file$e, 39, 12, 1277);
    			add_location(li5, file$e, 38, 10, 1260);
    			add_location(b9, file$e, 43, 12, 1432);
    			add_location(li6, file$e, 42, 10, 1415);
    			add_location(b10, file$e, 46, 14, 1576);
    			add_location(li7, file$e, 46, 10, 1572);
    			add_location(b11, file$e, 47, 14, 1650);
    			add_location(li8, file$e, 47, 10, 1646);
    			add_location(ul0, file$e, 28, 8, 887);
    			add_location(li9, file$e, 24, 6, 688);
    			add_location(br2, file$e, 50, 6, 1744);
    			add_location(b12, file$e, 52, 8, 1770);
    			add_location(b13, file$e, 56, 14, 1971);
    			add_location(li10, file$e, 56, 10, 1967);
    			add_location(b14, file$e, 57, 14, 2025);
    			add_location(li11, file$e, 57, 10, 2021);
    			add_location(b15, file$e, 59, 12, 2098);
    			add_location(li12, file$e, 58, 10, 2081);
    			add_location(b16, file$e, 62, 12, 2210);
    			add_location(li13, file$e, 61, 10, 2193);
    			add_location(b17, file$e, 66, 12, 2342);
    			add_location(li14, file$e, 65, 10, 2325);
    			add_location(b18, file$e, 70, 12, 2497);
    			add_location(li15, file$e, 69, 10, 2480);
    			add_location(b19, file$e, 73, 14, 2641);
    			add_location(li16, file$e, 73, 10, 2637);
    			add_location(b20, file$e, 74, 14, 2715);
    			add_location(li17, file$e, 74, 10, 2711);
    			add_location(ul1, file$e, 55, 8, 1952);
    			add_location(li18, file$e, 51, 6, 1757);
    			add_location(br3, file$e, 77, 6, 2809);
    			add_location(b21, file$e, 79, 8, 2835);
    			add_location(li19, file$e, 78, 6, 2822);
    			add_location(ul2, file$e, 23, 4, 677);
    			add_location(li20, file$e, 18, 2, 502);
    			add_location(ul3, file$e, 14, 0, 413);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$d = "src/docs/pages/SCR_ConfigurationOnError.svelte";
    ...
    function create_default_slot_1$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "/");
    			set_style(a, "pointer-events", "none");
    			add_location(a, file$d, 22, 6, 941);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    		},
    ...
    function create_default_slot$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$d, 54, 6, 2029);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$d, 53, 4, 2005);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pagefooter.$$.fragment);
    			attr_dev(h4, "class", "scr-h4");
    			add_location(h4, file$d, 8, 2, 308);
    			add_location(b0, file$d, 10, 8, 405);
    			add_location(br0, file$d, 12, 4, 521);
    			add_location(br1, file$d, 13, 4, 532);
    			add_location(br2, file$d, 17, 4, 772);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$d, 9, 2, 368);
    			attr_dev(b1, "class", "scr-b");
    			add_location(b1, file$d, 27, 0, 1087);
    			attr_dev(b2, "class", "scr-b");
    			add_location(b2, file$d, 30, 0, 1222);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$d, 25, 2, 1061);
    			add_location(br3, file$d, 33, 2, 1381);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$d, 36, 2, 1418);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$d, 41, 4, 1620);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$d, 40, 2, 1588);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$d, 43, 2, 1701);
    			attr_dev(div, "class", "scr-page");
    			add_location(div, file$d, 7, 0, 283);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$c = "src/docs/pages/SCR_RouteObjectProperties.svelte";

    // (470:2) <SCR_PageFooter>
    function create_default_slot$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$c, 471, 6, 15888);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$c, 470, 4, 15864);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t102 = text("The ");
    			b21 = element("b");
    			b21.textContent = "loadingComponent";
    			t104 = text(" is a custom loaded loading component to use with\n    this specific route. When set it will override any global loading component set\n    for this route only.");
    			t105 = space();
    			pre6 = element("pre");
    			b22 = element("b");
    			b22.textContent = "// ## Loading Component - the loading component that is going to be used \n// ## for this route\n// ## Function - Imported loading component for this route\n// ## Default value: none";
    			t107 = text("\n\n");
    			b23 = element("b");
    			b23.textContent = "// Import your component";
    			t109 = text("\nimport SRC_Loading from \"./testComponents/SRC_Loading.svelte\";\n\n{\n  ");
    			b24 = element("b");
    			b24.textContent = "// Setting your route loading component";
    			...
    			t116 = text("The ");
    			b25 = element("b");
    			b25.textContent = "lazyLoadLoadingComponent";
    			t118 = text(" is a custom loading component to be loaded\n    to use with this specific route. When set it will override any global loading\n    component set for this route only.");
    			t119 = space();
    			pre7 = element("pre");
    			b26 = element("b");
    			b26.textContent = "// ## Lazy Load Loading Component - the loading component that must be loaded to be used \n// ## for this route\n// ## Function - Function to load the loading component for this route\n// ## Default value: none";
    			t121 = text("\n\n{\n  ");
    			b27 = element("b");
    			b27.textContent = "// Lazy loading your route loading component";
    			...
    			t128 = text("The ");
    			b28 = element("b");
    			b28.textContent = "params";
    			t130 = text(" option is an object that must be available on before enter\n    functions or even the components.\n    ");
    			br17 = element("br");
    			...
    			t139 = text("The ");
    			b30 = element("b");
    			b30.textContent = "loadingProps";
    			t141 = text(" option is an object that will be available on\n    loading component.\n    ");
    			br18 = element("br");
    			...
    			pre9 = element("pre");
    			b31 = element("b");
    			b31.textContent = "// ## Loading Props - all props that must be available to\n// loading component when it is triggered\n// ## Object\n// ## Default value: {}";
    			...
    			t152 = text("The ");
    			b32 = element("b");
    			b32.textContent = "ignoreLayout";
    			t154 = text(" option when set to true, ignores any layout defined to\n    this specific route.");
    			t155 = space();
    			pre10 = element("pre");
    			b33 = element("b");
    			b33.textContent = "// ## Ignore Layout - if should ignore layout component\n// ## when you do not want to use global or local layout component\n// ## Boolean\n// ## Default value: false";
    			t157 = text("\n{\n  ignoreLayout: false,\n}");
    			t158 = space();
    			hr11 = element("hr");
    			t159 = space();
    			...
    			t162 = text("The ");
    			b34 = element("b");
    			b34.textContent = "ignoreScroll";
    			t164 = text(" option when set to true, ignores any scroll behaviour\n    defined.");
    			t165 = space();
    			pre11 = element("pre");
    			b35 = element("b");
    			b35.textContent = "// ## Ignore Scroll - if this route should ignore scrolling\n// ## Boolean\n// ## Default value: false";
    			t167 = text("\n{\n  ignoreScroll: false,\n}");
    			t168 = space();
    			hr12 = element("hr");
    			t169 = space();
    			...
    			b36 = element("b");
    			b36.textContent = "scrollProps";
    			t174 = text(" option overrides the store ");
    			b37 = element("b");
    			b37.textContent = "scrollProps";
    			t176 = text(" configuration\n    for this specific route.");
    			t177 = space();
    			pre12 = element("pre");
    			b38 = element("b");
    			b38.textContent = "// ## Scroll Props\n// ## The scrolling props on entering the route if enabled\n// ## Default Values: \n// ## Object\n// ## Default value: configuration store";
    			t179 = text("\n{\n  scrollProps: {\n    top: 0,\n    left: 0,\n    behavior: \"smooth\",\n    timeout: 10, // timeout must be greater than 10 milliseconds\n  },\n}");
    			t180 = space();
    			hr13 = element("hr");
    			t181 = space();
    			...
    			t184 = text("The ");
    			b39 = element("b");
    			b39.textContent = "title";
    			t186 = text(" option sets when enters the route the page title.");
    			t187 = space();
    			pre13 = element("pre");
    			b40 = element("b");
    			b40.textContent = "// ## Title - it defines the route title\n// ## String\n// ## Default value: none";
    			...
    			t194 = text("The ");
    			b41 = element("b");
    			b41.textContent = "ignoreGlobalBeforeFunction";
    			t196 = text(" option when is true will not execute any\n    Global Before Enter functions for this specific route.");
    			t197 = space();
    			pre14 = element("pre");
    			b42 = element("b");
    			b42.textContent = "// ## Ignore Global Before Function - \n// ## if should ignore defined global before function \n// ## Boolean\n// ## Default value: false";
    			...
    			create_component(scr_pagefooter.$$.fragment);
    			attr_dev(h40, "class", "scr-h4");
    			add_location(h40, file$c, 6, 2, 180);
    			add_location(br0, file$c, 10, 4, 372);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$c, 7, 2, 232);
    			attr_dev(hr0, "class", "scr-hr");
    			add_location(hr0, file$c, 15, 2, 589);
    			attr_dev(h41, "class", "scr-h4");
    			add_location(h41, file$c, 16, 2, 613);
    			add_location(b0, file$c, 18, 8, 681);
    			add_location(br1, file$c, 20, 4, 774);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$c, 17, 2, 644);
    			attr_dev(b1, "class", "scr-b");
    			add_location(b1, file$c, 27, 0, 994);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$c, 25, 2, 968);
    			attr_dev(hr1, "class", "scr-hr");
    			add_location(hr1, file$c, 39, 2, 1357);
    			attr_dev(h42, "class", "scr-h4");
    			add_location(h42, file$c, 40, 2, 1381);
    			add_location(b2, file$c, 42, 8, 1449);
    			add_location(br2, file$c, 43, 4, 1510);
    			add_location(br3, file$c, 44, 4, 1521);
    			add_location(br4, file$c, 48, 4, 1710);
    			add_location(br5, file$c, 49, 4, 1721);
    			add_location(br6, file$c, 51, 4, 1796);
    			add_location(b3, file$c, 52, 4, 1807);
    			add_location(br7, file$c, 53, 4, 1865);
    			add_location(br8, file$c, 54, 4, 1876);
    			attr_dev(p2, "class", "scr-text-justify");
    			add_location(p2, file$c, 41, 2, 1412);
    			attr_dev(b4, "class", "scr-b");
    			add_location(b4, file$c, 60, 0, 2019);
    			attr_dev(b5, "class", "scr-b");
    			add_location(b5, file$c, 71, 2, 2307);
    			attr_dev(b6, "class", "scr-b");
    			add_location(b6, file$c, 77, 2, 2491);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$c, 58, 2, 1993);
    			attr_dev(hr2, "class", "scr-hr");
    			add_location(hr2, file$c, 87, 2, 2810);
    			attr_dev(h43, "class", "scr-h4");
    			add_location(h43, file$c, 88, 2, 2834);
    			add_location(b7, file$c, 90, 8, 2907);
    			add_location(br9, file$c, 92, 4, 3039);
    			add_location(br10, file$c, 93, 4, 3050);
    			attr_dev(p3, "class", "scr-text-justify");
    			add_location(p3, file$c, 89, 2, 2870);
    			attr_dev(b8, "class", "scr-b");
    			add_location(b8, file$c, 99, 0, 3190);
    			attr_dev(b9, "class", "scr-b");
    			add_location(b9, file$c, 106, 0, 3374);
    			attr_dev(b10, "class", "scr-b");
    			add_location(b10, file$c, 110, 2, 3483);
    			attr_dev(pre2, "class", "scr-pre");
    			add_location(pre2, file$c, 97, 2, 3164);
    			attr_dev(hr3, "class", "scr-hr");
    			add_location(hr3, file$c, 116, 2, 3751);
    			attr_dev(h44, "class", "scr-h4");
    			add_location(h44, file$c, 117, 2, 3775);
    			add_location(b11, file$c, 119, 8, 3858);
    			add_location(br11, file$c, 121, 4, 3992);
    			add_location(br12, file$c, 122, 4, 4003);
    			attr_dev(p4, "class", "scr-text-justify");
    			add_location(p4, file$c, 118, 2, 3821);
    			attr_dev(b12, "class", "scr-b");
    			add_location(b12, file$c, 128, 0, 4143);
    			attr_dev(b13, "class", "scr-b");
    			add_location(b13, file$c, 136, 2, 4360);
    			attr_dev(pre3, "class", "scr-pre");
    			add_location(pre3, file$c, 126, 2, 4117);
    			attr_dev(hr4, "class", "scr-hr");
    			add_location(hr4, file$c, 142, 2, 4683);
    			attr_dev(h45, "class", "scr-h4");
    			add_location(h45, file$c, 143, 2, 4707);
    			add_location(b14, file$c, 145, 8, 4787);
    			add_location(br13, file$c, 148, 4, 4950);
    			add_location(br14, file$c, 149, 4, 4961);
    			attr_dev(p5, "class", "scr-text-justify");
    			add_location(p5, file$c, 144, 2, 4750);
    			attr_dev(b15, "class", "scr-b");
    			add_location(b15, file$c, 155, 0, 5104);
    			attr_dev(b16, "class", "scr-b");
    			add_location(b16, file$c, 162, 0, 5305);
    			attr_dev(b17, "class", "scr-b");
    			add_location(b17, file$c, 166, 2, 5422);
    			attr_dev(pre4, "class", "scr-pre");
    			add_location(pre4, file$c, 153, 2, 5078);
    			attr_dev(hr5, "class", "scr-hr");
    			add_location(hr5, file$c, 172, 2, 5709);
    			attr_dev(h46, "class", "scr-h4");
    			add_location(h46, file$c, 173, 2, 5733);
    			add_location(b18, file$c, 175, 8, 5823);
    			add_location(br15, file$c, 178, 4, 6000);
    			add_location(br16, file$c, 179, 4, 6011);
    			attr_dev(p6, "class", "scr-text-justify");
    			add_location(p6, file$c, 174, 2, 5786);
    			attr_dev(b19, "class", "scr-b");
    			add_location(b19, file$c, 185, 0, 6159);
    			attr_dev(b20, "class", "scr-b");
    			add_location(b20, file$c, 193, 2, 6397);
    			attr_dev(pre5, "class", "scr-pre");
    			add_location(pre5, file$c, 183, 2, 6133);
    			attr_dev(hr6, "class", "scr-hr");
    			add_location(hr6, file$c, 199, 2, 6737);
    			attr_dev(h47, "class", "scr-h4");
    			add_location(h47, file$c, 200, 2, 6761);
    			add_location(b21, file$c, 202, 8, 6842);
    			attr_dev(p7, "class", "scr-text-justify");
    			add_location(p7, file$c, 201, 2, 6805);
    			attr_dev(b22, "class", "scr-b");
    			add_location(b22, file$c, 208, 0, 7059);
    			attr_dev(b23, "class", "scr-b");
    			add_location(b23, file$c, 215, 0, 7263);
    			attr_dev(b24, "class", "scr-b");
    			add_location(b24, file$c, 219, 2, 7382);
    			attr_dev(pre6, "class", "scr-pre");
    			add_location(pre6, file$c, 206, 2, 7033);
    			attr_dev(hr7, "class", "scr-hr");
    			add_location(hr7, file$c, 225, 2, 7673);
    			attr_dev(h48, "class", "scr-h4");
    			add_location(h48, file$c, 226, 2, 7697);
    			add_location(b25, file$c, 228, 8, 7788);
    			attr_dev(p8, "class", "scr-text-justify");
    			add_location(p8, file$c, 227, 2, 7751);
    			attr_dev(b26, "class", "scr-b");
    			add_location(b26, file$c, 234, 0, 8019);
    			attr_dev(b27, "class", "scr-b");
    			add_location(b27, file$c, 242, 2, 8260);
    			attr_dev(pre7, "class", "scr-pre");
    			add_location(pre7, file$c, 232, 2, 7993);
    			attr_dev(hr8, "class", "scr-hr");
    			add_location(hr8, file$c, 247, 2, 8513);
    			attr_dev(h49, "class", "scr-h4");
    			add_location(h49, file$c, 248, 2, 8537);
    			add_location(b28, file$c, 250, 8, 8607);
    			add_location(br17, file$c, 252, 4, 8722);
    			attr_dev(p9, "class", "scr-text-justify");
    			add_location(p9, file$c, 249, 2, 8570);
    			attr_dev(b29, "class", "scr-b");
    			add_location(b29, file$c, 259, 0, 8954);
    			attr_dev(pre8, "class", "scr-pre");
    			add_location(pre8, file$c, 257, 2, 8928);
    			attr_dev(hr9, "class", "scr-hr");
    			add_location(hr9, file$c, 274, 2, 9426);
    			attr_dev(h410, "class", "scr-h4");
    			add_location(h410, file$c, 275, 2, 9450);
    			add_location(b30, file$c, 277, 8, 9527);
    			add_location(br18, file$c, 279, 4, 9620);
    			add_location(br19, file$c, 283, 4, 9824);
    			add_location(br20, file$c, 284, 4, 9835);
    			attr_dev(p10, "class", "scr-text-justify");
    			add_location(p10, file$c, 276, 2, 9490);
    			attr_dev(b31, "class", "scr-b");
    			add_location(b31, file$c, 289, 0, 9949);
    			attr_dev(pre9, "class", "scr-pre");
    			add_location(pre9, file$c, 287, 2, 9923);
    			attr_dev(hr10, "class", "scr-hr");
    			add_location(hr10, file$c, 301, 2, 10382);
    			attr_dev(h411, "class", "scr-h4");
    			add_location(h411, file$c, 302, 2, 10406);
    			add_location(b32, file$c, 304, 8, 10483);
    			attr_dev(p11, "class", "scr-text-justify");
    			add_location(p11, file$c, 303, 2, 10446);
    			attr_dev(b33, "class", "scr-b");
    			add_location(b33, file$c, 309, 0, 10618);
    			attr_dev(pre10, "class", "scr-pre");
    			add_location(pre10, file$c, 307, 2, 10592);
    			attr_dev(hr11, "class", "scr-hr");
    			add_location(hr11, file$c, 321, 2, 11031);
    			attr_dev(h412, "class", "scr-h4");
    			add_location(h412, file$c, 322, 2, 11055);
    			add_location(b34, file$c, 324, 8, 11132);
    			attr_dev(p12, "class", "scr-text-justify");
    			add_location(p12, file$c, 323, 2, 11095);
    			attr_dev(b35, "class", "scr-b");
    			add_location(b35, file$c, 329, 0, 11254);
    			attr_dev(pre11, "class", "scr-pre");
    			add_location(pre11, file$c, 327, 2, 11228);
    			attr_dev(hr12, "class", "scr-hr");
    			add_location(hr12, file$c, 340, 2, 11604);
    			attr_dev(h413, "class", "scr-h4");
    			add_location(h413, file$c, 341, 2, 11628);
    			add_location(b36, file$c, 343, 8, 11704);
    			add_location(b37, file$c, 343, 54, 11750);
    			attr_dev(p13, "class", "scr-text-justify");
    			add_location(p13, file$c, 342, 2, 11667);
    			attr_dev(b38, "class", "scr-b");
    			add_location(b38, file$c, 348, 0, 11847);
    			attr_dev(pre12, "class", "scr-pre");
    			add_location(pre12, file$c, 346, 2, 11821);
    			attr_dev(hr13, "class", "scr-hr");
    			add_location(hr13, file$c, 366, 2, 12374);
    			attr_dev(h414, "class", "scr-h4");
    			add_location(h414, file$c, 367, 2, 12398);
    			add_location(b39, file$c, 369, 8, 12467);
    			attr_dev(p14, "class", "scr-text-justify");
    			add_location(p14, file$c, 368, 2, 12430);
    			attr_dev(b40, "class", "scr-b");
    			add_location(b40, file$c, 373, 0, 12565);
    			attr_dev(pre13, "class", "scr-pre");
    			add_location(pre13, file$c, 371, 2, 12539);
    			attr_dev(hr14, "class", "scr-hr");
    			add_location(hr14, file$c, 384, 2, 12906);
    			attr_dev(h415, "class", "scr-h4");
    			add_location(h415, file$c, 385, 2, 12930);
    			add_location(b41, file$c, 387, 8, 13023);
    			attr_dev(p15, "class", "scr-text-justify");
    			add_location(p15, file$c, 386, 2, 12986);
    			attr_dev(b42, "class", "scr-b");
    			add_location(b42, file$c, 392, 0, 13192);
    			attr_dev(pre14, "class", "scr-pre");
    			add_location(pre14, file$c, 390, 2, 13166);
    			attr_dev(hr15, "class", "scr-hr");
    			add_location(hr15, file$c, 404, 2, 13590);
    			attr_dev(h416, "class", "scr-h4");
    			add_location(h416, file$c, 405, 2, 13614);
    			add_location(b43, file$c, 407, 8, 13713);
    			add_location(br21, file$c, 411, 4, 13963);
    			attr_dev(p16, "class", "scr-text-justify");
    			add_location(p16, file$c, 406, 2, 13676);
    			attr_dev(b44, "class", "scr-b");
    			add_location(b44, file$c, 417, 0, 14101);
    			attr_dev(pre15, "class", "scr-pre");
    			add_location(pre15, file$c, 415, 2, 14075);
    			attr_dev(hr16, "class", "scr-hr");
    			add_location(hr16, file$c, 430, 2, 14582);
    			attr_dev(h417, "class", "scr-h4");
    			add_location(h417, file$c, 431, 2, 14606);
    			add_location(b45, file$c, 433, 8, 14682);
    			add_location(br22, file$c, 436, 4, 14913);
    			add_location(br23, file$c, 437, 4, 14924);
    			attr_dev(p17, "class", "scr-text-justify");
    			add_location(p17, file$c, 432, 2, 14645);
    			attr_dev(b46, "class", "scr-b");
    			add_location(b46, file$c, 442, 0, 15019);
    			attr_dev(pre16, "class", "scr-pre");
    			add_location(pre16, file$c, 440, 2, 14993);
    			attr_dev(p18, "class", "scr-text-justify");
    			add_location(p18, file$c, 453, 2, 15301);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$c, 458, 4, 15490);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$c, 457, 2, 15458);
    			attr_dev(pre17, "class", "scr-pre");
    			add_location(pre17, file$c, 460, 2, 15571);
    			attr_dev(div, "class", "scr-page");
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div, pre6);
    			append_dev(pre6, b22);
    			append_dev(pre6, t107);
    			append_dev(pre6, b23);
    			append_dev(pre6, t109);
    			append_dev(pre6, b24);
    			append_dev(pre6, t111);
    			append_dev(div, t112);
    			append_dev(div, hr7);
    			append_dev(div, t113);
    			append_dev(div, h48);
    			...
    			append_dev(div, t155);
    			append_dev(div, pre10);
    			append_dev(pre10, b33);
    			append_dev(pre10, t157);
    			append_dev(div, t158);
    			append_dev(div, hr11);
    			append_dev(div, t159);
    			append_dev(div, h412);
    			...
    			append_dev(div, t165);
    			append_dev(div, pre11);
    			append_dev(pre11, b35);
    			append_dev(pre11, t167);
    			append_dev(div, t168);
    			append_dev(div, hr12);
    			append_dev(div, t169);
    			append_dev(div, h413);
    			...
    			append_dev(div, t177);
    			append_dev(div, pre12);
    			append_dev(pre12, b38);
    			append_dev(pre12, t179);
    			append_dev(div, t180);
    			append_dev(div, hr13);
    			append_dev(div, t181);
    			append_dev(div, h414);
    			...
    			append_dev(pre13, b40);
    			append_dev(pre13, t189);
    			append_dev(div, t190);
    			append_dev(div, hr14);
    			append_dev(div, t191);
    			append_dev(div, h415);
    			...
    			append_dev(pre14, b42);
    			append_dev(pre14, t199);
    			append_dev(div, t200);
    			append_dev(div, hr15);
    			append_dev(div, t201);
    			append_dev(div, h416);
    			...
    			append_dev(pre15, b44);
    			append_dev(pre15, t210);
    			append_dev(div, t211);
    			append_dev(div, hr16);
    			append_dev(div, t212);
    			append_dev(div, h417);
    			...
    			append_dev(pre16, b46);
    			append_dev(pre16, t222);
    			append_dev(div, t223);
    			append_dev(div, p18);
    			append_dev(div, t225);
    			append_dev(div, center);
    ...
    const file$b = "src/docs/pages/SCR_RouteObjectBeforeEnter.svelte";
    ...
    function create_default_slot_1$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "/");
    			set_style(a, "pointer-events", "none");
    			add_location(a, file$b, 32, 6, 1468);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    		},
    ...
    function create_default_slot$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$b, 74, 6, 2803);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$b, 73, 4, 2779);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pagefooter.$$.fragment);
    			attr_dev(h4, "class", "scr-h4");
    			add_location(h4, file$b, 8, 2, 326);
    			add_location(b0, file$b, 10, 8, 427);
    			add_location(b1, file$b, 12, 4, 565);
    			add_location(br0, file$b, 14, 4, 649);
    			add_location(br1, file$b, 15, 4, 660);
    			add_location(br2, file$b, 20, 4, 963);
    			add_location(br3, file$b, 21, 4, 974);
    			add_location(b2, file$b, 23, 4, 1057);
    			add_location(br4, file$b, 26, 4, 1294);
    			add_location(br5, file$b, 27, 4, 1305);
    			add_location(br6, file$b, 34, 4, 1580);
    			add_location(br7, file$b, 35, 4, 1591);
    			attr_dev(p, "class", "scr-text-justify");
    			add_location(p, file$b, 9, 2, 390);
    			attr_dev(b3, "class", "scr-b");
    			add_location(b3, file$b, 40, 0, 1685);
    			attr_dev(b4, "class", "scr-b");
    			add_location(b4, file$b, 41, 0, 1743);
    			attr_dev(b5, "class", "scr-b");
    			add_location(b5, file$b, 45, 0, 1878);
    			attr_dev(b6, "class", "scr-b");
    			add_location(b6, file$b, 47, 0, 1907);
    			attr_dev(b7, "class", "scr-b");
    			add_location(b7, file$b, 48, 0, 1976);
    			attr_dev(b8, "class", "scr-b");
    			add_location(b8, file$b, 49, 0, 2037);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$b, 38, 2, 1659);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$b, 61, 4, 2381);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$b, 60, 2, 2349);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$b, 63, 2, 2462);
    			attr_dev(div, "class", "scr-page");
    			add_location(div, file$b, 7, 0, 301);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$a = "src/docs/pages/SCR_RouteObjectAfterBeforeEnter.svelte";
    ...
    function create_default_slot$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$a, 129, 6, 4687);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$a, 128, 4, 4663);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b0, file$a, 8, 8, 286);
    			add_location(br0, file$a, 12, 4, 566);
    			add_location(br1, file$a, 13, 4, 577);
    			add_location(br2, file$a, 17, 4, 783);
    			add_location(br3, file$a, 18, 4, 794);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$a, 7, 2, 249);
    			attr_dev(b1, "class", "scr-b");
    			add_location(b1, file$a, 23, 0, 888);
    			attr_dev(b2, "class", "scr-b");
    			add_location(b2, file$a, 24, 0, 946);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$a, 21, 2, 862);
    			attr_dev(hr, "class", "scr-hr");
    			add_location(hr, file$a, 29, 2, 1111);
    			attr_dev(h41, "class", "scr-h4");
    			add_location(h41, file$a, 30, 2, 1135);
    			add_location(br4, file$a, 34, 4, 1323);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$a, 31, 2, 1204);
    			attr_dev(b3, "class", "scr-b");
    			add_location(b3, file$a, 39, 0, 1384);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$a, 37, 2, 1358);
    			add_location(b4, file$a, 46, 6, 1559);
    			add_location(br5, file$a, 48, 6, 1651);
    			add_location(b5, file$a, 52, 10, 1761);
    			add_location(b6, file$a, 56, 16, 1974);
    			add_location(li0, file$a, 56, 12, 1970);
    			add_location(b7, file$a, 57, 16, 2030);
    			add_location(li1, file$a, 57, 12, 2026);
    			add_location(b8, file$a, 59, 14, 2107);
    			add_location(li2, file$a, 58, 12, 2088);
    			add_location(b9, file$a, 63, 14, 2239);
    			add_location(li3, file$a, 62, 12, 2220);
    			add_location(b10, file$a, 67, 14, 2379);
    			add_location(li4, file$a, 66, 12, 2360);
    			add_location(b11, file$a, 71, 14, 2542);
    			add_location(li5, file$a, 70, 12, 2523);
    			add_location(b12, file$a, 74, 16, 2692);
    			add_location(li6, file$a, 74, 12, 2688);
    			add_location(b13, file$a, 75, 16, 2768);
    			add_location(li7, file$a, 75, 12, 2764);
    			add_location(ul0, file$a, 55, 10, 1953);
    			add_location(li8, file$a, 51, 8, 1746);
    			add_location(br6, file$a, 78, 8, 2868);
    			add_location(b14, file$a, 80, 10, 2898);
    			add_location(b15, file$a, 84, 16, 3107);
    			add_location(li9, file$a, 84, 12, 3103);
    			add_location(b16, file$a, 85, 16, 3163);
    			add_location(li10, file$a, 85, 12, 3159);
    			add_location(b17, file$a, 87, 14, 3240);
    			add_location(li11, file$a, 86, 12, 3221);
    			add_location(b18, file$a, 91, 14, 3372);
    			add_location(li12, file$a, 90, 12, 3353);
    			add_location(b19, file$a, 95, 14, 3512);
    			add_location(li13, file$a, 94, 12, 3493);
    			add_location(b20, file$a, 99, 14, 3675);
    			add_location(li14, file$a, 98, 12, 3656);
    			add_location(b21, file$a, 102, 16, 3825);
    			add_location(li15, file$a, 102, 12, 3821);
    			add_location(b22, file$a, 103, 16, 3901);
    			add_location(li16, file$a, 103, 12, 3897);
    			add_location(ul1, file$a, 83, 10, 3086);
    			add_location(li17, file$a, 79, 8, 2883);
    			add_location(br7, file$a, 106, 8, 4001);
    			add_location(b23, file$a, 108, 10, 4031);
    			add_location(li18, file$a, 107, 8, 4016);
    			add_location(ul2, file$a, 50, 6, 1733);
    			add_location(li19, file$a, 45, 4, 1548);
    			add_location(ul3, file$a, 44, 2, 1539);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$a, 116, 4, 4251);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$a, 115, 2, 4219);
    			attr_dev(pre2, "class", "scr-pre");
    			add_location(pre2, file$a, 118, 2, 4332);
    			attr_dev(div, "class", "scr-page");
    ...
    const file$9 = "src/docs/pages/SCR_RouteObjectOnError.svelte";
    ...
    function create_default_slot_1$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "/");
    			set_style(a, "pointer-events", "none");
    			add_location(a, file$9, 22, 6, 949);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    		},
    ...
    function create_default_slot$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$9, 54, 6, 1899);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$9, 53, 4, 1875);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pagefooter.$$.fragment);
    			attr_dev(h4, "class", "scr-h4");
    			add_location(h4, file$9, 8, 2, 308);
    			add_location(b0, file$9, 10, 8, 404);
    			add_location(br0, file$9, 12, 4, 529);
    			add_location(br1, file$9, 13, 4, 540);
    			add_location(br2, file$9, 17, 4, 780);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$9, 9, 2, 367);
    			attr_dev(b1, "class", "scr-b");
    			add_location(b1, file$9, 28, 0, 1096);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$9, 25, 2, 1069);
    			add_location(br3, file$9, 33, 2, 1250);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$9, 36, 2, 1285);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$9, 41, 4, 1494);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$9, 40, 2, 1462);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$9, 43, 2, 1575);
    			attr_dev(div, "class", "scr-page");
    			add_location(div, file$9, 7, 0, 283);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$8 = "src/docs/pages/SCR_RouteComponentProperties.svelte";
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "/");
    			set_style(a, "pointer-events", "none");
    			add_location(a, file$8, 18, 6, 679);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_default_slot_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "/");
    			set_style(a, "pointer-events", "none");
    			add_location(a, file$8, 66, 6, 2447);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    		},
    ...
    function create_default_slot$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$8, 169, 6, 5815);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$8, 168, 4, 5791);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pagefooter.$$.fragment);
    			attr_dev(h40, "class", "scr-h4");
    			add_location(h40, file$8, 7, 2, 232);
    			attr_dev(a, "href", "https://svelte.dev/tutorial/basics");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$8, 9, 29, 345);
    			add_location(br0, file$8, 22, 4, 869);
    			add_location(br1, file$8, 23, 4, 880);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$8, 8, 2, 287);
    			attr_dev(b0, "class", "scr-b");
    			add_location(b0, file$8, 30, 0, 978);
    			attr_dev(b1, "class", "scr-b");
    			add_location(b1, file$8, 37, 0, 1365);
    			attr_dev(b2, "class", "scr-b");
    			add_location(b2, file$8, 40, 8, 1454);
    			attr_dev(b3, "class", "scr-b");
    			add_location(b3, file$8, 44, 0, 1514);
    			attr_dev(b4, "class", "scr-b");
    			add_location(b4, file$8, 51, 21, 1792);
    			attr_dev(b5, "class", "scr-b");
    			add_location(b5, file$8, 52, 28, 1919);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$8, 27, 2, 951);
    			attr_dev(hr0, "class", "scr-hr");
    			add_location(hr0, file$8, 56, 2, 2038);
    			attr_dev(h41, "class", "scr-h4");
    			add_location(h41, file$8, 57, 2, 2062);
    			add_location(br2, file$8, 61, 4, 2263);
    			add_location(br3, file$8, 70, 4, 2569);
    			add_location(br4, file$8, 71, 4, 2580);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$8, 58, 2, 2095);
    			attr_dev(b6, "class", "scr-b");
    			add_location(b6, file$8, 77, 0, 2703);
    			attr_dev(b7, "class", "scr-b");
    			add_location(b7, file$8, 84, 4, 2865);
    			attr_dev(b8, "class", "scr-b");
    			add_location(b8, file$8, 89, 4, 3069);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$8, 74, 2, 2676);
    			attr_dev(p2, "class", "scr-text-justify");
    			add_location(p2, file$8, 116, 2, 4123);
    			attr_dev(hr1, "class", "scr-hr");
    			add_location(hr1, file$8, 120, 2, 4316);
    			attr_dev(h42, "class", "scr-h4");
    			add_location(h42, file$8, 121, 2, 4340);
    			add_location(b9, file$8, 123, 8, 4413);
    			attr_dev(p3, "class", "scr-text-justify");
    			add_location(p3, file$8, 122, 2, 4376);
    			attr_dev(b10, "class", "scr-b");
    			add_location(b10, file$8, 130, 0, 4668);
    			attr_dev(pre2, "class", "scr-pre");
    			add_location(pre2, file$8, 127, 2, 4641);
    			attr_dev(hr2, "class", "scr-hr");
    			add_location(hr2, file$8, 135, 2, 4760);
    			attr_dev(h43, "class", "scr-h4");
    			add_location(h43, file$8, 136, 2, 4784);
    			add_location(b11, file$8, 138, 8, 4865);
    			attr_dev(p4, "class", "scr-text-justify");
    			add_location(p4, file$8, 137, 2, 4828);
    			attr_dev(b12, "class", "scr-b");
    			add_location(b12, file$8, 145, 0, 5091);
    			attr_dev(pre3, "class", "scr-pre");
    			add_location(pre3, file$8, 142, 2, 5064);
    			attr_dev(p5, "class", "scr-text-justify");
    			add_location(p5, file$8, 150, 2, 5190);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$8, 155, 4, 5400);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$8, 154, 2, 5368);
    			attr_dev(pre4, "class", "scr-pre");
    			add_location(pre4, file$8, 157, 2, 5481);
    			attr_dev(div, "class", "scr-page");
    			add_location(div, file$8, 6, 0, 207);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$7 = "src/docs/pages/SCR_RouteComponentComponents.svelte";
    ...
    function create_default_slot$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$7, 245, 6, 7263);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$7, 244, 4, 7239);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$7, 11, 4, 489);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$7, 7, 2, 235);
    			attr_dev(hr0, "class", "scr-hr");
    			add_location(hr0, file$7, 14, 2, 549);
    			attr_dev(h41, "class", "scr-h4");
    			add_location(h41, file$7, 15, 2, 573);
    			add_location(br1, file$7, 20, 4, 826);
    			add_location(br2, file$7, 23, 4, 960);
    			add_location(br3, file$7, 24, 4, 971);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$7, 16, 2, 616);
    			attr_dev(b0, "class", "scr-b");
    			add_location(b0, file$7, 30, 0, 1094);
    			attr_dev(b1, "class", "scr-b");
    			add_location(b1, file$7, 34, 0, 1277);
    			attr_dev(b2, "class", "scr-b");
    			add_location(b2, file$7, 37, 8, 1366);
    			attr_dev(b3, "class", "scr-b");
    			add_location(b3, file$7, 41, 0, 1426);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$7, 27, 2, 1067);
    			attr_dev(p2, "class", "scr-text-justify");
    			add_location(p2, file$7, 47, 2, 1573);
    			attr_dev(b4, "class", "scr-b");
    			add_location(b4, file$7, 50, 0, 1677);
    			attr_dev(b5, "class", "scr-b");
    			add_location(b5, file$7, 55, 2, 1848);
    			attr_dev(b6, "class", "scr-b");
    			add_location(b6, file$7, 59, 2, 2000);
    			attr_dev(b7, "class", "scr-b");
    			add_location(b7, file$7, 73, 4, 2399);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$7, 48, 2, 1651);
    			attr_dev(hr1, "class", "scr-hr");
    			add_location(hr1, file$7, 84, 2, 2701);
    			attr_dev(h42, "class", "scr-h4");
    			add_location(h42, file$7, 85, 2, 2725);
    			add_location(br4, file$7, 89, 4, 2912);
    			add_location(b8, file$7, 90, 20, 2939);
    			add_location(b9, file$7, 91, 4, 2996);
    			attr_dev(p3, "class", "scr-text-justify");
    			add_location(p3, file$7, 86, 2, 2769);
    			attr_dev(b10, "class", "scr-b");
    			add_location(b10, file$7, 96, 0, 3061);
    			attr_dev(b11, "class", "scr-b");
    			add_location(b11, file$7, 100, 0, 3246);
    			attr_dev(b12, "class", "scr-b");
    			add_location(b12, file$7, 103, 8, 3335);
    			attr_dev(b13, "class", "scr-b");
    			add_location(b13, file$7, 107, 0, 3395);
    			attr_dev(pre2, "class", "scr-pre");
    			add_location(pre2, file$7, 93, 2, 3034);
    			attr_dev(p4, "class", "scr-text-justify");
    			add_location(p4, file$7, 113, 2, 3537);
    			attr_dev(b14, "class", "scr-b");
    			add_location(b14, file$7, 116, 0, 3642);
    			attr_dev(b15, "class", "scr-b");
    			add_location(b15, file$7, 119, 2, 3722);
    			attr_dev(pre3, "class", "scr-pre");
    			add_location(pre3, file$7, 114, 2, 3616);
    			attr_dev(hr2, "class", "scr-hr");
    			add_location(hr2, file$7, 141, 2, 4262);
    			attr_dev(h43, "class", "scr-h4");
    			add_location(h43, file$7, 142, 2, 4286);
    			add_location(br5, file$7, 146, 4, 4484);
    			attr_dev(p5, "class", "scr-text-justify");
    			add_location(p5, file$7, 143, 2, 4332);
    			attr_dev(b16, "class", "scr-b");
    			add_location(b16, file$7, 152, 0, 4577);
    			attr_dev(b17, "class", "scr-b");
    			add_location(b17, file$7, 156, 0, 4764);
    			attr_dev(b18, "class", "scr-b");
    			add_location(b18, file$7, 159, 8, 4853);
    			attr_dev(b19, "class", "scr-b");
    			add_location(b19, file$7, 163, 0, 4913);
    			attr_dev(pre4, "class", "scr-pre");
    			add_location(pre4, file$7, 149, 2, 4550);
    			attr_dev(p6, "class", "scr-text-justify");
    			add_location(p6, file$7, 169, 2, 5057);
    			attr_dev(b20, "class", "scr-b");
    			add_location(b20, file$7, 172, 0, 5164);
    			attr_dev(b21, "class", "scr-b");
    			add_location(b21, file$7, 175, 2, 5246);
    			attr_dev(pre5, "class", "scr-pre");
    			add_location(pre5, file$7, 170, 2, 5138);
    			attr_dev(hr3, "class", "scr-hr");
    			add_location(hr3, file$7, 184, 2, 5563);
    			attr_dev(h44, "class", "scr-h4");
    			add_location(h44, file$7, 185, 2, 5587);
    			add_location(br6, file$7, 189, 4, 5765);
    			attr_dev(p7, "class", "scr-text-justify");
    			add_location(p7, file$7, 186, 2, 5629);
    			attr_dev(b22, "class", "scr-b");
    			add_location(b22, file$7, 195, 0, 5858);
    			attr_dev(b23, "class", "scr-b");
    			add_location(b23, file$7, 199, 0, 6039);
    			attr_dev(b24, "class", "scr-b");
    			add_location(b24, file$7, 202, 8, 6128);
    			attr_dev(b25, "class", "scr-b");
    			add_location(b25, file$7, 206, 0, 6188);
    			attr_dev(pre6, "class", "scr-pre");
    			add_location(pre6, file$7, 192, 2, 5831);
    			attr_dev(p8, "class", "scr-text-justify");
    			add_location(p8, file$7, 212, 2, 6326);
    			attr_dev(b26, "class", "scr-b");
    			add_location(b26, file$7, 215, 0, 6429);
    			attr_dev(b27, "class", "scr-b");
    			add_location(b27, file$7, 218, 2, 6507);
    			attr_dev(pre7, "class", "scr-pre");
    			add_location(pre7, file$7, 213, 2, 6403);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$7, 231, 4, 6848);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$7, 230, 2, 6816);
    			attr_dev(pre8, "class", "scr-pre");
    			add_location(pre8, file$7, 233, 2, 6929);
    			attr_dev(div, "class", "scr-page");
    ...
    const file$6 = "src/docs/pages/SCR_NavigationRouting.svelte";
    ...
    function create_default_slot$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$6, 97, 6, 2756);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$6, 96, 4, 2732);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pagefooter.$$.fragment);
    			attr_dev(h40, "class", "scr-h4");
    			add_location(h40, file$6, 6, 2, 180);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$6, 7, 2, 227);
    			add_location(b0, file$6, 9, 8, 319);
    			add_location(li0, file$6, 9, 4, 315);
    			add_location(b1, file$6, 11, 6, 381);
    			add_location(li1, file$6, 10, 4, 370);
    			add_location(ul0, file$6, 8, 2, 306);
    			add_location(b2, file$6, 16, 43, 560);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$6, 15, 2, 488);
    			attr_dev(hr0, "class", "scr-hr");
    			add_location(hr0, file$6, 19, 2, 631);
    			attr_dev(h41, "class", "scr-h4");
    			add_location(h41, file$6, 20, 2, 655);
    			attr_dev(b3, "class", "scr-b");
    			add_location(b3, file$6, 23, 4, 722);
    			attr_dev(b4, "class", "scr-b");
    			add_location(b4, file$6, 28, 0, 847);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$6, 21, 2, 692);
    			attr_dev(hr1, "class", "scr-hr");
    			add_location(hr1, file$6, 35, 2, 961);
    			attr_dev(h42, "class", "scr-h4");
    			add_location(h42, file$6, 36, 2, 985);
    			attr_dev(p2, "class", "scr-text-justify");
    			add_location(p2, file$6, 37, 2, 1039);
    			add_location(b5, file$6, 42, 6, 1160);
    			add_location(b6, file$6, 45, 12, 1272);
    			add_location(li2, file$6, 45, 8, 1268);
    			add_location(b7, file$6, 46, 12, 1343);
    			add_location(li3, file$6, 46, 8, 1339);
    			add_location(b8, file$6, 47, 12, 1419);
    			add_location(li4, file$6, 47, 8, 1415);
    			add_location(ul1, file$6, 44, 6, 1255);
    			add_location(li5, file$6, 41, 4, 1149);
    			add_location(br0, file$6, 50, 4, 1511);
    			add_location(b9, file$6, 52, 6, 1533);
    			add_location(li6, file$6, 51, 4, 1522);
    			add_location(br1, file$6, 55, 4, 1673);
    			add_location(b10, file$6, 57, 6, 1695);
    			add_location(li7, file$6, 56, 4, 1684);
    			add_location(ul2, file$6, 40, 2, 1140);
    			attr_dev(hr2, "class", "scr-hr");
    			add_location(hr2, file$6, 62, 2, 1921);
    			attr_dev(h43, "class", "scr-h4");
    			add_location(h43, file$6, 63, 2, 1945);
    			attr_dev(b11, "class", "scr-b");
    			add_location(b11, file$6, 66, 4, 2012);
    			attr_dev(b12, "class", "scr-b");
    			add_location(b12, file$6, 71, 0, 2137);
    			attr_dev(b13, "class", "scr-b");
    			add_location(b13, file$6, 75, 2, 2199);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$6, 64, 2, 1982);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$6, 83, 4, 2370);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$6, 82, 2, 2338);
    			attr_dev(pre2, "class", "scr-pre");
    			add_location(pre2, file$6, 85, 2, 2451);
    			attr_dev(div, "class", "scr-page");
    ...
    const file$5 = "src/docs/pages/SCR_NavigationStore.svelte";
    ...
    function create_default_slot$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$5, 61, 6, 1620);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$5, 60, 4, 1596);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pagefooter.$$.fragment);
    			attr_dev(h4, "class", "scr-h4");
    			add_location(h4, file$5, 6, 2, 180);
    			add_location(br0, file$5, 13, 4, 592);
    			add_location(br1, file$5, 14, 4, 603);
    			attr_dev(p, "class", "scr-text-justify");
    			add_location(p, file$5, 7, 2, 225);
    			attr_dev(b0, "class", "scr-b");
    			add_location(b0, file$5, 20, 4, 748);
    			attr_dev(b1, "class", "scr-b");
    			add_location(b1, file$5, 27, 0, 885);
    			attr_dev(b2, "class", "scr-b");
    			add_location(b2, file$5, 32, 2, 948);
    			attr_dev(b3, "class", "scr-b");
    			add_location(b3, file$5, 37, 2, 1050);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$5, 18, 2, 718);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$5, 46, 4, 1241);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$5, 45, 2, 1209);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$5, 48, 2, 1322);
    			attr_dev(div, "class", "scr-page");
    ...
    const file$4 = "src/docs/pages/SCR_RouterLinkProperties.svelte";
    ...
    function create_default_slot$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$4, 105, 6, 3421);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$4, 104, 4, 3397);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$4, 10, 4, 380);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$4, 7, 2, 217);
    			attr_dev(b0, "class", "scr-b");
    			add_location(b0, file$4, 15, 4, 465);
    			attr_dev(b1, "class", "scr-b");
    			add_location(b1, file$4, 22, 0, 626);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$4, 13, 2, 435);
    			attr_dev(hr, "class", "scr-hr");
    			add_location(hr, file$4, 35, 2, 1056);
    			attr_dev(h41, "class", "scr-h4");
    			add_location(h41, file$4, 36, 2, 1080);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$4, 37, 2, 1117);
    			add_location(b2, file$4, 43, 6, 1270);
    			add_location(b3, file$4, 46, 12, 1382);
    			add_location(li0, file$4, 46, 8, 1378);
    			add_location(b4, file$4, 47, 12, 1453);
    			add_location(li1, file$4, 47, 8, 1449);
    			add_location(b5, file$4, 48, 12, 1529);
    			add_location(li2, file$4, 48, 8, 1525);
    			add_location(ul0, file$4, 45, 6, 1365);
    			add_location(li3, file$4, 42, 4, 1259);
    			add_location(br1, file$4, 51, 4, 1621);
    			add_location(b6, file$4, 53, 6, 1643);
    			add_location(li4, file$4, 52, 4, 1632);
    			add_location(br2, file$4, 56, 4, 1776);
    			add_location(b7, file$4, 58, 6, 1798);
    			add_location(li5, file$4, 57, 4, 1787);
    			add_location(br3, file$4, 62, 4, 2018);
    			add_location(b8, file$4, 64, 6, 2040);
    			add_location(li6, file$4, 63, 4, 2029);
    			add_location(ul1, file$4, 41, 2, 1250);
    			attr_dev(p2, "class", "scr-text-justify");
    			add_location(p2, file$4, 68, 2, 2183);
    			attr_dev(b9, "class", "scr-b");
    			add_location(b9, file$4, 71, 4, 2273);
    			attr_dev(b10, "class", "scr-b");
    			add_location(b10, file$4, 78, 0, 2434);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$4, 69, 2, 2243);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$4, 91, 4, 3023);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$4, 90, 2, 2991);
    			attr_dev(pre2, "class", "scr-pre");
    			add_location(pre2, file$4, 93, 2, 3104);
    			attr_dev(div, "class", "scr-page");
    ...
    const file$3 = "src/docs/pages/SCR_RouterStoreProperties.svelte";
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$3, 109, 6, 3071);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$3, 108, 4, 3047);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file$3, 10, 4, 388);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$3, 7, 2, 218);
    			attr_dev(b0, "class", "scr-b");
    			add_location(b0, file$3, 15, 4, 473);
    			attr_dev(b1, "class", "scr-b");
    			add_location(b1, file$3, 21, 2, 619);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$3, 13, 2, 443);
    			attr_dev(hr, "class", "scr-hr");
    			add_location(hr, file$3, 39, 2, 1200);
    			attr_dev(h41, "class", "scr-h4");
    			add_location(h41, file$3, 40, 2, 1224);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$3, 41, 2, 1261);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$3, 42, 2, 1328);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$3, 95, 4, 2669);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$3, 94, 2, 2637);
    			attr_dev(pre2, "class", "scr-pre");
    			add_location(pre2, file$3, 97, 2, 2750);
    			attr_dev(div, "class", "scr-page");
    ...
    /* src/docs/pages/SCR_TestRegexPath.svelte generated by Svelte v3.37.0 */
    const file$2 = "src/docs/pages/SCR_TestRegexPath.svelte";
    ...
    function create_default_slot_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div.textContent = "Test Route With Param";
    			attr_dev(div, "class", "scr-btn svelte-r5my8r");
    			add_location(div, file$2, 37, 4, 1065);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$2, 56, 6, 1584);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$2, 55, 4, 1560);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pagefooter.$$.fragment);
    			attr_dev(h4, "class", "scr-h4");
    			add_location(h4, file$2, 16, 2, 471);
    			add_location(br0, file$2, 19, 4, 587);
    			add_location(br1, file$2, 20, 4, 598);
    			add_location(b, file$2, 21, 36, 641);
    			add_location(br2, file$2, 22, 4, 671);
    			add_location(br3, file$2, 23, 4, 682);
    			attr_dev(p, "class", "scr-text-justify");
    			add_location(p, file$2, 17, 2, 515);
    			attr_dev(label, "for", "scr-next-param");
    			attr_dev(label, "class", "form-label");
    			add_location(label, file$2, 27, 4, 733);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "form-control form-control-sm");
    			attr_dev(input, "id", "scr-next-param");
    			attr_dev(input, "placeholder", ":teste");
    			add_location(input, file$2, 28, 4, 804);
    			attr_dev(div0, "class", "mb-3");
    			add_location(div0, file$2, 26, 2, 710);
    			attr_dev(hr, "class", "scr-hr");
    			add_location(hr, file$2, 39, 2, 1137);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$2, 41, 4, 1193);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$2, 40, 2, 1161);
    			attr_dev(pre, "class", "scr-pre");
    			add_location(pre, file$2, 43, 2, 1274);
    			attr_dev(div1, "class", "scr-page");
    			add_location(div1, file$2, 15, 0, 446);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/docs/pages/SCR_TestRegexPath2.svelte generated by Svelte v3.37.0 */
    const file$1 = "src/docs/pages/SCR_TestRegexPath2.svelte";
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div.textContent = "Test Route With Param";
    			attr_dev(div, "class", "scr-btn svelte-r5my8r");
    			add_location(div, file$1, 85, 4, 2615);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pushroutebutton1.$$.fragment);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$1, 104, 6, 3156);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$1, 103, 4, 3132);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(scr_pagefooter.$$.fragment);
    			attr_dev(h4, "class", "scr-h4");
    			add_location(h4, file$1, 26, 2, 670);
    			add_location(br0, file$1, 30, 4, 903);
    			attr_dev(p0, "class", "scr-text-justify");
    			add_location(p0, file$1, 27, 2, 716);
    			attr_dev(b0, "class", "scr-b");
    			add_location(b0, file$1, 35, 0, 997);
    			attr_dev(b1, "class", "scr-b");
    			add_location(b1, file$1, 42, 0, 1245);
    			attr_dev(b2, "class", "scr-b");
    			add_location(b2, file$1, 43, 0, 1322);
    			attr_dev(b3, "class", "scr-b");
    			add_location(b3, file$1, 44, 0, 1422);
    			attr_dev(pre0, "class", "scr-pre");
    			add_location(pre0, file$1, 33, 2, 971);
    			add_location(b4, file$1, 49, 42, 1699);
    			add_location(br1, file$1, 50, 4, 1734);
    			add_location(b5, file$1, 51, 43, 1784);
    			add_location(br2, file$1, 52, 4, 1820);
    			add_location(br3, file$1, 53, 4, 1831);
    			attr_dev(p1, "class", "scr-text-justify");
    			add_location(p1, file$1, 48, 2, 1628);
    			attr_dev(label0, "for", "scr-next-first-param");
    			attr_dev(label0, "class", "form-label");
    			add_location(label0, file$1, 57, 4, 1882);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "form-control form-control-sm");
    			attr_dev(input0, "id", "scr-next-first-param");
    			attr_dev(input0, "placeholder", ":firstParam");
    			add_location(input0, file$1, 60, 4, 1982);
    			attr_dev(div0, "class", "mb-3");
    			add_location(div0, file$1, 56, 2, 1859);
    			attr_dev(label1, "for", "scr-next-second-param");
    			attr_dev(label1, "class", "form-label");
    			add_location(label1, file$1, 69, 4, 2189);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "class", "form-control form-control-sm");
    			attr_dev(input1, "id", "scr-next-second-param");
    			attr_dev(input1, "placeholder", ":secondParam");
    			add_location(input1, file$1, 72, 4, 2291);
    			attr_dev(div1, "class", "mb-3");
    			add_location(div1, file$1, 68, 2, 2166);
    			attr_dev(hr, "class", "scr-hr");
    			add_location(hr, file$1, 87, 2, 2687);
    			attr_dev(small, "class", "scr-small");
    			add_location(small, file$1, 89, 4, 2743);
    			attr_dev(center, "class", "scr-center");
    			add_location(center, file$1, 88, 2, 2711);
    			attr_dev(pre1, "class", "scr-pre");
    			add_location(pre1, file$1, 91, 2, 2824);
    			attr_dev(div2, "class", "scr-page");
    			add_location(div2, file$1, 25, 0, 645);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class SCR_TestRegexPath2 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { pathParams: 0 });
    ...
    /* src/docs/SCR_Loading.svelte generated by Svelte v3.37.0 */

    const file = "src/docs/SCR_Loading.svelte";
